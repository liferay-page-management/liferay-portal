...
public class AssetVocabularyUtil {
	...
	public static List<AssetVocabulary> filterFindByG_V(
		...
		return getPersistence().filterFindByG_V(groupIds, visibilityType);
	}
	...
	public static List<AssetVocabulary> filterFindByG_V(
		...
		return getPersistence().filterFindByG_V(
			groupIds, visibilityType, start, end);
	}
	...
	public static List<AssetVocabulary> findByG_V(
		...
		return getPersistence().findByG_V(groupIds, visibilityType);
	}
	...
	public static List<AssetVocabulary> findByG_V(
		...
		return getPersistence().findByG_V(groupIds, visibilityType, start, end);
	}
	 ...
	 * @return the number of matching asset vocabularies
	 */
	public static int countByG_V(long[] groupIds, int visibilityType) {
		return getPersistence().countByG_V(groupIds, visibilityType);
	}
	 ...
	 * @return the number of matching asset vocabularies that the user has permission to view
	 */
	public static int filterCountByG_V(long[] groupIds, int visibilityType) {
		return getPersistence().filterCountByG_V(groupIds, visibilityType);
	}
