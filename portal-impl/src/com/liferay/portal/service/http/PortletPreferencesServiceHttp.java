...
public class PortletPreferencesServiceHttp {
	...
	public static String getPreferencesXML(
		...
		try {
			MethodKey methodKey = new MethodKey(
				PortletPreferencesServiceUtil.class, "getPreferencesXML",
				_getPreferencesXMLParameterTypes1);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, companyId, groupId, ownerId, ownerType, plid,
				portletId);
	...
	public static com.liferay.portal.kernel.model.PortletPreferences
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, ownerId, ownerType, plid, portletId, xml);
	...
	private static final Class<?>[] _getPreferencesXMLParameterTypes1 =
		new Class[] {
