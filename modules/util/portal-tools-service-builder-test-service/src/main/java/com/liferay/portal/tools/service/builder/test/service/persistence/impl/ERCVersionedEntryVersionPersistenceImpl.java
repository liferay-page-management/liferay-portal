...
public class ERCVersionedEntryVersionPersistenceImpl
	...
	/**
	 * Returns all the erc versioned entry versions where externalReferenceCode = &#63; and groupId = &#63;.
	 *
	 ...
	 */
	@Override
	public List<ERCVersionedEntryVersion> findByERC_G(
	...
	/**
	 * Returns a range of all the erc versioned entry versions where externalReferenceCode = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ERCVersionedEntryVersionModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the erc versioned entry versions where externalReferenceCode = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ERCVersionedEntryVersionModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the first erc versioned entry version in the ordered set where externalReferenceCode = &#63; and groupId = &#63;.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion findByERC_G_First(
			String externalReferenceCode, long groupId,
			OrderByComparator<ERCVersionedEntryVersion> orderByComparator)
		throws NoSuchERCVersionedEntryVersionException {

		ERCVersionedEntryVersion ercVersionedEntryVersion = fetchByERC_G_First(
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion fetchByERC_G_First(
		String externalReferenceCode, long groupId,
		OrderByComparator<ERCVersionedEntryVersion> orderByComparator) {

		List<ERCVersionedEntryVersion> list = findByERC_G(
	...
	/**
	 * Returns the last erc versioned entry version in the ordered set where externalReferenceCode = &#63; and groupId = &#63;.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion findByERC_G_Last(
			String externalReferenceCode, long groupId,
			OrderByComparator<ERCVersionedEntryVersion> orderByComparator)
		throws NoSuchERCVersionedEntryVersionException {

		ERCVersionedEntryVersion ercVersionedEntryVersion = fetchByERC_G_Last(
			externalReferenceCode, groupId, orderByComparator);
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion fetchByERC_G_Last(
		String externalReferenceCode, long groupId,
		OrderByComparator<ERCVersionedEntryVersion> orderByComparator) {
	...
	/**
	 * Returns the erc versioned entry versions before and after the current erc versioned entry version in the ordered set where externalReferenceCode = &#63; and groupId = &#63;.
	 *
	 * @param ercVersionedEntryVersionId the primary key of the current erc versioned entry version
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion[] findByERC_G_PrevAndNext(
			long ercVersionedEntryVersionId, String externalReferenceCode,
			long groupId,
			OrderByComparator<ERCVersionedEntryVersion> orderByComparator)
		throws NoSuchERCVersionedEntryVersionException {
		...
		try {
			...
			array[0] = getByERC_G_PrevAndNext(
				session, ercVersionedEntryVersion, externalReferenceCode,
	...
	protected ERCVersionedEntryVersion getByERC_G_PrevAndNext(
		Session session, ERCVersionedEntryVersion ercVersionedEntryVersion,
		String externalReferenceCode, long groupId,
		OrderByComparator<ERCVersionedEntryVersion> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the erc versioned entry versions where externalReferenceCode = &#63; and groupId = &#63; from the database.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 */
	...
	/**
	 * Returns the number of erc versioned entry versions where externalReferenceCode = &#63; and groupId = &#63;.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @return the number of matching erc versioned entry versions
	...
	private static final String _FINDER_COLUMN_ERC_G_EXTERNALREFERENCECODE_2 =
		"ercVersionedEntryVersion.externalReferenceCode = ? AND ";

	private static final String _FINDER_COLUMN_ERC_G_EXTERNALREFERENCECODE_3 =
		"(ercVersionedEntryVersion.externalReferenceCode IS NULL OR ercVersionedEntryVersion.externalReferenceCode = '') AND ";
	...
	/**
	 * Returns the erc versioned entry version where externalReferenceCode = &#63; and groupId = &#63; and version = &#63; or throws a <code>NoSuchERCVersionedEntryVersionException</code> if it could not be found.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @param version the version
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion findByERC_G_Version(
			String externalReferenceCode, long groupId, int version)
		throws NoSuchERCVersionedEntryVersionException {

		ERCVersionedEntryVersion ercVersionedEntryVersion =
			fetchByERC_G_Version(externalReferenceCode, groupId, version);
	...
	/**
	 * Returns the erc versioned entry version where externalReferenceCode = &#63; and groupId = &#63; and version = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @param version the version
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion fetchByERC_G_Version(
		String externalReferenceCode, long groupId, int version) {
	...
	/**
	 * Returns the erc versioned entry version where externalReferenceCode = &#63; and groupId = &#63; and version = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @param version the version
	...
	public ERCVersionedEntryVersion fetchByERC_G_Version(
		...
		if (useFinderCache) {
			finderArgs = new Object[] {externalReferenceCode, groupId, version};
		}
		...
		if (result == null) {
			...
			if (externalReferenceCode.isEmpty()) {
				sb.append(_FINDER_COLUMN_ERC_G_VERSION_EXTERNALREFERENCECODE_3);
			}
			else {
				bindExternalReferenceCode = true;

				sb.append(_FINDER_COLUMN_ERC_G_VERSION_EXTERNALREFERENCECODE_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByERC_G_Version, finderArgs, list);
					}
				}
				else {
					ERCVersionedEntryVersion ercVersionedEntryVersion =
	...
	/**
	 * Removes the erc versioned entry version where externalReferenceCode = &#63; and groupId = &#63; and version = &#63; from the database.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @param version the version
	 ...
	 */
	@Override
	public ERCVersionedEntryVersion removeByERC_G_Version(
			String externalReferenceCode, long groupId, int version)
		throws NoSuchERCVersionedEntryVersionException {

		ERCVersionedEntryVersion ercVersionedEntryVersion = findByERC_G_Version(
	...
	/**
	 * Returns the number of erc versioned entry versions where externalReferenceCode = &#63; and groupId = &#63; and version = &#63;.
	 *
	 * @param externalReferenceCode the external reference code
	 * @param groupId the group ID
	 * @param version the version
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
			ercVersionedEntryVersionModelImpl.getExternalReferenceCode(),
			ercVersionedEntryVersionModelImpl.getGroupId(),
			ercVersionedEntryVersionModelImpl.getVersion()
		};
