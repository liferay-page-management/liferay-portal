...
public class CreateInfoItemStrutsAction implements StrutsAction {
	...
	public String execute(
		...
		try {
			...
			InfoRequestFieldValuesProvider infoRequestFieldValuesProvider =
				_infoItemServiceTracker.getFirstInfoItemService(
					InfoRequestFieldValuesProvider.class, className);

			InfoItemFieldValues infoItemFieldValues =
				infoRequestFieldValuesProvider.create(httpServletRequest);
