...
public class RepeatableInfoFieldValueInfoItemObjectProvider
	...
	public RepeatableInfoFieldValue getInfoItem(
		...
		InfoItemReference infoItemReference =
			repeatableInfoFieldValueInfoItemIdentifier.getInfoItemReference();

		InfoItemIdentifier nextInfoItemIdentifier =
			infoItemReference.getInfoItemIdentifier();

		InfoItemObjectProvider<?> infoItemObjectProvider =
			_infoItemServiceRegistry.getFirstInfoItemService(
				InfoItemObjectProvider.class, infoItemReference.getClassName(),
				nextInfoItemIdentifier.getInfoItemServiceFilter());

		Object infoItem = infoItemObjectProvider.getInfoItem(
			nextInfoItemIdentifier);
