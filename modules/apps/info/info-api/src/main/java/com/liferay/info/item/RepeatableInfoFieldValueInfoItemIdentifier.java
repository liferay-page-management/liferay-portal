...
public class RepeatableInfoFieldValueInfoItemIdentifier
	...
	public RepeatableInfoFieldValueInfoItemIdentifier(
		List<String> fieldNames, InfoItemReference infoItemReference,
		int iterationNumber) {
	...
	public boolean equals(Object object) {
		...
		if (Objects.equals(
			...
			Objects.equals(
				_infoItemReference,
				repeatableFieldInfoItemIdentifier._infoItemReference) &&
			Objects.equals(
				_iterationNumber,
	...
	@Override
	public int hashCode() {
		return Objects.hash(_fieldNames, _infoItemReference, _iterationNumber);
	}
	...
	public String toString() {
		return StringBundler.concat(
			...
			_iterationNumber, ", _infoItemIdentifier=", _infoItemReference,
			"}");
	}
