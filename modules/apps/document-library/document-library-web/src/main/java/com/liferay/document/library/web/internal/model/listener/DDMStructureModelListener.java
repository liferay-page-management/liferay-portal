...
import com.liferay.document.library.web.internal.info.collection.provider.FileEntryDDMStructureRelatedInfoCollectionProvider;
	...
	public void onAfterCreate(DDMStructure ddmStructure)
		...
		serviceRegistrations.put(
			...
			_bundleContext.registerService(
				...
				new FileEntryDDMStructureRelatedInfoCollectionProvider(
					ddmStructure, _repositoryProvider),
				null));
	}
