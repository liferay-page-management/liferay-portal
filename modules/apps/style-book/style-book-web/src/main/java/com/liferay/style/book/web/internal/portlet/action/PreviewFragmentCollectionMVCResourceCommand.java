...
public class PreviewFragmentCollectionMVCResourceCommand
	...
	protected void doServeResource(
		...
		httpServletRequest.setAttribute(
			StyleBookWebKeys.RENDER_FRAGMENT_ENTRY_LINK_URL,
			_getRenderFragmentEntryLinkURL(groupId, resourceResponse));
	...
	private String _getRenderFragmentEntryLinkURL(
		long groupId, ResourceResponse resourceResponse) {
