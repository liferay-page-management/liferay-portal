...
public class ClientExtensionEntryRelCacheModel
	...
	public ClientExtensionEntryRel toEntityModel() {
		...
		if (clientExtensionName == null) {
			clientExtensionEntryRelImpl.setClientExtensionName("");
		}
		else {
			clientExtensionEntryRelImpl.setClientExtensionName(
				clientExtensionName);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		clientExtensionName = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput) throws IOException {
		...
		if (clientExtensionName == null) {
			...
			objectOutput.writeUTF(clientExtensionName);
		}
	...
	public long classPK;
	public String clientExtensionName;
	public String type;
