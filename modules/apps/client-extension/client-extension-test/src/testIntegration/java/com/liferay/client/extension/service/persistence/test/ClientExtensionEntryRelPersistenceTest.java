...
public class ClientExtensionEntryRelPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newClientExtensionEntryRel.setClientExtensionName(
			RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingClientExtensionEntryRel.getClientExtensionName(),
			newClientExtensionEntryRel.getClientExtensionName());
		Assert.assertEquals(
	...
	protected OrderByComparator<ClientExtensionEntryRel>
		...
		return OrderByComparatorFactoryUtil.create(
			...
			"clientExtensionName", true, "type", true);
	}
	...
	protected ClientExtensionEntryRel addClientExtensionEntryRel()
		...
		clientExtensionEntryRel.setClientExtensionName(
			RandomTestUtil.randomString());
