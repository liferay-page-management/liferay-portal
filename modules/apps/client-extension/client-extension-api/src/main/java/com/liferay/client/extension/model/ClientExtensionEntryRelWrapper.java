...
public class ClientExtensionEntryRelWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("clientExtensionName", getClientExtensionName());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String clientExtensionName = (String)attributes.get(
			"clientExtensionName");

		if (clientExtensionName != null) {
			setClientExtensionName(clientExtensionName);
		}
	...
	/**
	 * Returns the client extension name of this client extension entry rel.
	 *
	 * @return the client extension name of this client extension entry rel
	 */
	@Override
	public String getClientExtensionName() {
		return model.getClientExtensionName();
	}
	...
	/**
	 * Sets the client extension name of this client extension entry rel.
	 *
	 * @param clientExtensionName the client extension name of this client extension entry rel
	 */
	@Override
	public void setClientExtensionName(String clientExtensionName) {
		model.setClientExtensionName(clientExtensionName);
	}
