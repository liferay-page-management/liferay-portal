...
public class SegmentsWebKeys {
	...
	public static final String SEGMENTS_EXPERIENCE_NAME =
		"SEGMENTS_EXPERIENCE_NAME";

	public static final String SEGMENTS_EXPERIENCES_DROPDOWN_ITEMS =
		"SEGMENTS_EXPERIENCES_DROPDOWN_ITEMS";
