...
<portlet:renderURL var="restoreTrashURL" windowState="<%= LiferayWindowState.POP_UP.toString() %>">
	...
	<portlet:param name="classNameId" value="<%= trashDisplayContext.getClassNameId() %>" />
	<portlet:param name="classPK" value="<%= trashDisplayContext.getClassPK() %>" />
	<portlet:param name="containerModelClassNameId" value="<%= PortalUtil.getClassNameId(trashHandler.getContainerModelClassName(trashDisplayContext.getClassPK())) %>" />
</portlet:renderURL>
