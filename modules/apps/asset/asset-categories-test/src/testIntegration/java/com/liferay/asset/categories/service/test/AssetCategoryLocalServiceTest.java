...
import com.liferay.asset.kernel.exception.AssetCategoryLimitExceededExceptionException;
...
public class AssetCategoryLocalServiceTest {
	...
	@Test(expected = AssetCategoryLimitExceededExceptionException.class)
