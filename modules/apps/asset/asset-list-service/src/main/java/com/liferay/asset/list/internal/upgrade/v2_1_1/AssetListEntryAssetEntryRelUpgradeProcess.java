...
public class AssetListEntryAssetEntryRelUpgradeProcess extends UpgradeProcess {
	...
	private void _updateAssetListEntryAssetEntryRelPositions(
		...
		PreparedStatement preparedStatement, long segmentsEntryId) {
		...
		try (PreparedStatement selectPreparedStatement =
			...
			selectPreparedStatement.setLong(1, ctCollectionId);
			selectPreparedStatement.setLong(2, assetListEntryId);
			selectPreparedStatement.setLong(3, segmentsEntryId);
			selectPreparedStatement.setLong(4, positions.get(0));
			...
			try (ResultSet resultSet = selectPreparedStatement.executeQuery()) {
				while (resultSet.next()) {
					...
					preparedStatement.setLong(1, curPosition);
