	...
	<liferay-frontend:edit-form-body>
		...
		<liferay-frontend:fieldset-group>
			...
			>
				...
				<aui:input helpMessage="for-internal-use-only-help" label="for-internal-use-only" name="visibilityType" type="toggle-switch" value="<%= (vocabulary != null) ? (vocabulary.getVisibilityType() == AssetVocabularyConstants.VISIBILITY_TYPE_INTERNAL) : false %>" />
			</liferay-frontend:fieldset>
