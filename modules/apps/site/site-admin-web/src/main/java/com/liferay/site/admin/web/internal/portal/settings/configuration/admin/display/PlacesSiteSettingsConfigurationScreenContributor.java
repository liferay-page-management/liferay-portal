...
import com.liferay.dynamic.data.mapping.form.field.type.util.DDMFormFieldTypePlacesUtil;
...
public class PlacesSiteSettingsConfigurationScreenContributor
	...
	public String getJspPath() {
		return "/site_settings/places.jsp";
	}

	@Override
	public String getKey() {
		return "site-configuration-places";
	}
	...
	public void setAttributes(
		...
		httpServletRequest.setAttribute(
			...
			DDMFormFieldTypePlacesUtil.getPlacesKey(
