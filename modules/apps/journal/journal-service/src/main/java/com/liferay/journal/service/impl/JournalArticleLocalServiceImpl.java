...
public class JournalArticleLocalServiceImpl
	 ...
	 * @param      friendlyURLMap the web content article's locales and
	 *             localized friendly URLs
	 ...
	 *             boolean, double, Map, Map, Map, String, long, String, String,
	 *             int, int, int, int, int, int, int, int, int, int, boolean,
	 *             int, int, int, int, int, boolean, boolean, boolean, int,
	...
	public JournalArticle addArticle(
		...
		return journalArticleLocalService.addArticle(
			...
			_getSmallImageSource(smallImage, smallImageURL), smallImageURL,
	...
	public JournalArticle addArticleDefaultValues(
		...
		return journalArticleLocalService.addArticleDefaultValues(
			...
			smallImage, _getSmallImageSource(smallImage, smallImageURL),
	 ...
	 *             boolean, double, Map, Map, Map, String, long, String, String,
	 *             int, int, int, int, int, int, int, int, int, int, boolean,
	 *             int, int, int, int, int, boolean, boolean, boolean, String,
	 *             File, Map, String, ServiceContext)} description.
	 * @param      ddmTemplateKey the primary key of the web content article's
	 *             DDM template
	 * @param      layoutUuid the unique string identifying the web content
	 *             article's display page
	 ...
	 *             Map, String, String, String, int, int, int, int, int, int,
	 *             int, int, int, int, boolean, int, int, int, int, int,
	 *             boolean, boolean, boolean, int, String, File, Map, String,
	 *             ServiceContext)}
	 */
	@Deprecated
	@Indexable(type = IndexableType.REINDEX)
	...
	public JournalArticle updateArticle(
			...
			int reviewDateYear, int reviewDateHour, int reviewDateMinute,
			boolean neverReview, boolean indexable, boolean smallImage,
			int smallImageResource, String smallImageURL, File smallImageFile,
			Map<String, byte[]> images, String articleURL,
			ServiceContext serviceContext)
		throws PortalException {
		...
		return journalArticleLocalService.updateArticle(
			...
			neverExpire, reviewDateMonth, reviewDateDay, reviewDateYear,
			reviewDateHour, reviewDateMinute, neverReview, indexable,
			smallImage, smallImageResource, smallImageURL, null, null, null,
			serviceContext);
	}
	...
	/**
	 * @deprecated As of Cavanaugh (7.4.x), replaced by {@link
	 *             #updateArticleDefaultValues(long, long, String, Map, Map,
	 *             String, String, String, int, int, int, int, int, int, int,
	 *             int, int, int, boolean, int, int, int, int, int, boolean,
	 *             boolean, boolean, int, String, File, ServiceContext)}
	 */
	@Deprecated
	@Override
	public JournalArticle updateArticleDefaultValues(
	...
	private int _getSmallImageSource(boolean smallImage, String smallImageURL) {
		if (!smallImage) {
			return JournalArticleConstants.SMALL_IMAGE_TYPE_NONE;
		}

		if (Validator.isNotNull(smallImageURL)) {
			return JournalArticleConstants.SMALL_IMAGE_TYPE_URL;
		}

		return JournalArticleConstants.SMALL_IMAGE_TYPE_USER_COMPUTER;
	}
