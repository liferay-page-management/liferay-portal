				...
				<div class="alert alert-warning text-center">
					<c:choose>
						<c:when test="<%= (selectedArticle != null) && (selectedArticle.getGroupId() != themeDisplay.getScopeGroupId()) %>">
							<liferay-ui:message arguments='<%= "<strong><em>" + HtmlUtil.escape(selectedArticle.getTitle(locale)) + "</strong></em>" %>' key="the-web-content-article-x-does-not-belong-to-the-scope-of-this-widget" />
						</c:when>
