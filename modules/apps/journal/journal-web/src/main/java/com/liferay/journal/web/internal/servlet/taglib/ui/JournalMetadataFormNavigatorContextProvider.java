 ...
 */
@Component(
	property = FormNavigatorContextConstants.FORM_NAVIGATOR_ID + "=" + FormNavigatorConstants.FORM_NAVIGATOR_ID_JOURNAL_METADATA,
	service = FormNavigatorContextProvider.class
)
public class JournalMetadataFormNavigatorContextProvider
