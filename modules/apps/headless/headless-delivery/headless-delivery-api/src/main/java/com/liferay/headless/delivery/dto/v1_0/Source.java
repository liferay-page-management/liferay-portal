 ...
 */
@Generated("")
@GraphQLName(description = "The source of the form.", value = "Source")
...
public class Source implements Serializable {
	...
	@Schema(description = "The source's item reference.")
	@Valid
	...
	@GraphQLField(description = "The source's item reference.")
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.Source",
		name = "x-class-name"
	)
