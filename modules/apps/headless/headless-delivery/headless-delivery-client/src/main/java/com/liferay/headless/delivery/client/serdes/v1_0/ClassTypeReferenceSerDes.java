...
public class ClassTypeReferenceSerDes {
	...
	public static String toJSON(ClassTypeReference classTypeReference) {
		...
		if (classTypeReference.getClassTypeId() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(classTypeReference.getClassTypeId());
		}
	...
	public static Map<String, String> toMap(
		...
		if (classTypeReference.getClassTypeId() == null) {
			...
			map.put(
				"classTypeId",
				String.valueOf(classTypeReference.getClassTypeId()));
		}
	...
	public static class ClassTypeReferenceJSONParser
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "classTypeId")) {
				if (jsonParserFieldValue != null) {
					classTypeReference.setClassTypeId(
