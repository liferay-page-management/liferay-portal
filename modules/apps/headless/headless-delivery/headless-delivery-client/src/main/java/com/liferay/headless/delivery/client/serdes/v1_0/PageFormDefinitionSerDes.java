...
public class PageFormDefinitionSerDes {
	...
	public static String toJSON(PageFormDefinition pageFormDefinition) {
		...
		if (pageFormDefinition.getSource() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(pageFormDefinition.getSource()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (pageFormDefinition.getSource() == null) {
			...
			map.put("source", String.valueOf(pageFormDefinition.getSource()));
		}
