...
public class ResourceFolderResourceImpl extends BaseResourceFolderResourceImpl {
	...
	public Page<ResourceFolder> getSiteFragmentSetResourceFoldersPage(
		...
		return _searchResourceFolders(groupId, pagination, resourcesFolderId);
	}
	...
	private DLFolder _addDLFolder(
		...
		if (parentResourceFolder == null) {
			...
			parentFolderId = resourcesFolderId;
			...
			DLFolder dlFolder = _getOrAddDLFolder(
				parentResourceFolder, groupId);
		...
		Folder folder = _dlAppService.addFolder(
			resourceFolder.getExternalReferenceCode(), repositoryId,
	...
	private DLFolder _getOrAddDLFolder(
			ResourceFolder resourceFolder, long groupId)
		throws Exception {

		if ((resourceFolder == null) ||
			Validator.isNull(resourceFolder.getExternalReferenceCode())) {

			throw new IllegalArgumentException(
				_language.get(
					contextAcceptLanguage.getPreferredLocale(),
					"a-resource-folder-external-reference-code-is-required-" +
						"to-create-a-new-resource-folder"));
		}

		DLFolder dlFolder =
			_dlFolderLocalService.fetchDLFolderByExternalReferenceCode(
				resourceFolder.getExternalReferenceCode(), groupId);
	...
	private Page<ResourceFolder> _searchResourceFolders(
