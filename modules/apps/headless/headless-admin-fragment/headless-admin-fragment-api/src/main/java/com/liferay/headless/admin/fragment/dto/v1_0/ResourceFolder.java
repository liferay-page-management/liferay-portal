...
@Generated("")
@GraphQLName(
	description = "A folder that organizes a fragment set's resources (such as files and other folders).",
...
@XmlRootElement(name = "ResourceFolder")
public class ResourceFolder implements Serializable {

	public static ResourceFolder toDTO(String json) {
		return ObjectMapperUtil.readValue(ResourceFolder.class, json);
	}

	public static ResourceFolder unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(ResourceFolder.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The resource folder's creator."
	)
	@Valid
	...
	@GraphQLField(description = "The resource folder's creator.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The resource folder's creation date."
	)
	...
	@GraphQLField(description = "The resource folder's creation date.")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The last time the resource folder changed."
	)
	...
	@GraphQLField(description = "The last time the resource folder changed.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The resource folder's external reference code."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The resource folder's fragment set."
	)
	@Valid
	...
	@GraphQLField(description = "The resource folder's fragment set.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@GraphQLField(description = "The resource folder's name.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The resource folder's parent resource folder, when nested under another resource folder. Prefer `parentResourceFolderExternalReferenceCode` to reference an existing parent; this nested object is used to create the parent during a batch import and is also returned on read."
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The external reference code of the resource folder's parent resource folder. Takes precedence over `parentResourceFolder` when both are set."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.fragment.dto.v1_0.ResourceFolder",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:744160033