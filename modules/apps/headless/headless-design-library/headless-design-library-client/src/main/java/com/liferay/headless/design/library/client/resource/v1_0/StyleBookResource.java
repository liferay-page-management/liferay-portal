...
package com.liferay.headless.design.library.client.resource.v1_0;
...
public interface StyleBookResource {
	...
	public HttpInvoker.HttpResponse deleteAssetLibraryStyleBookHttpResponse(
			String assetLibraryExternalReferenceCode,
			String styleBookExternalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getAssetLibraryStyleBookHttpResponse(
			String assetLibraryExternalReferenceCode,
			String styleBookExternalReferenceCode)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getAssetLibraryStyleBooksPageHttpResponse(
			String assetLibraryExternalReferenceCode, String search,
			List<String> aggregations, String filterString,
			Pagination pagination, String sortString)
		throws Exception;
	...
	public static class StyleBookResourceImpl implements StyleBookResource {
		...
		public void deleteAssetLibraryStyleBook(
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteAssetLibraryStyleBookHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-design-library/v1.0/asset-libraries/{assetLibraryExternalReferenceCode}/style-books/{styleBookExternalReferenceCode}");
		...
		public StyleBook getAssetLibraryStyleBook(
			...
			HttpInvoker.HttpResponse httpResponse =
				getAssetLibraryStyleBookHttpResponse(
					assetLibraryExternalReferenceCode,
					styleBookExternalReferenceCode);
		...
		public Page<StyleBook> getAssetLibraryStyleBooksPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getAssetLibraryStyleBooksPageHttpResponse(
					assetLibraryExternalReferenceCode, search, aggregations,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-design-library/v1.0/asset-libraries/{assetLibraryExternalReferenceCode}/style-books");
