...
public abstract class BasePageTemplateResourceImpl
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
				name = "pageTemplateExternalReferenceCode", required = true
			)
		}
	)
	...
	public PageTemplate patchSitePageTemplate(
		...
		if (pageTemplate.getReadOnly() != null) {
			existingPageTemplate.setReadOnly(pageTemplate.getReadOnly());
		}
...
// LIFERAY-REST-BUILDER-HASH:-1286814138