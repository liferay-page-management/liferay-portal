...
public abstract class BasePageTemplateSetResourceTestCase {
		...
		Page<Permission> page =
			pageTemplateSetResource.
				getSiteSiteByExternalReferenceCodePageTemplateSetPermissionsPage(
					postPageTemplateSet.getId(), RoleConstants.GUEST);
	...
	public void testGetSiteSiteByExternalReferenceCodePageTemplateSetPageTemplatesPage()
		...
		if ((irrelevantSiteExternalReferenceCode != null) &&
			...
			PageTemplateSet irrelevantPageTemplateSet =
				testGetSiteSiteByExternalReferenceCodePageTemplateSetPageTemplatesPage_addPageTemplateSet(
					irrelevantSiteExternalReferenceCode,
	...
	protected void assertValid(PageTemplate pageTemplate) {
		boolean valid = true;
		...
		for (String additionalAssertFieldName :
				getAdditionalPageTemplateAssertFieldNames()) {
	...
	protected String[] getAdditionalPageTemplateAssertFieldNames() {
		return new String[0];
	}
