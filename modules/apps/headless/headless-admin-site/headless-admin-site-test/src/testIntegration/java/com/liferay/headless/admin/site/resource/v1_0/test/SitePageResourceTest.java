...
public class SitePageResourceTest extends BaseSitePageResourceTestCase {
	...
	public void testPostSiteSitePage() throws Exception {
		...
		_testPostSiteSitePage(_getRandomSitePage(SitePage.Type.CONTENT_PAGE));
		_testPostSiteSitePage(_getRandomSitePage(SitePage.Type.WIDGET_PAGE));
	...
	public void testPutSiteSitePage() throws Exception {
		_testPutSiteSitePage(SitePage.Type.CONTENT_PAGE);
		_testPutSiteSitePage(SitePage.Type.WIDGET_PAGE);
	...
	private void _assertPatchSiteSitePageProblemException(Layout... layouts)
		throws Exception {
	...
	private void _assertPutSiteSitePageProblemException(Layout... layouts)
		throws Exception {
	...
	private void _testPutSiteSitePage(SitePage.Type type) throws Exception {
		SitePage sitePage = testPostSiteSitePage_addSitePage(
			_getRandomSitePage(type));
