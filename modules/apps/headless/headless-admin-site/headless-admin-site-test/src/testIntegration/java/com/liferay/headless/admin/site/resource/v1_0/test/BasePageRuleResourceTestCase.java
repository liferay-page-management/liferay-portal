...
public abstract class BasePageRuleResourceTestCase {
	...
	public void testGetSiteSiteByExternalReferenceCodePageRulePageRuleActionsPage()
		...
		if ((irrelevantSiteExternalReferenceCode != null) &&
			...
			PageRule irrelevantPageRule =
				testGetSiteSiteByExternalReferenceCodePageRulePageRuleActionsPage_addPageRule(
	...
	public void testGetSiteSiteByExternalReferenceCodePageRulePageRuleConditionsPage()
		...
		if ((irrelevantSiteExternalReferenceCode != null) &&
			...
			PageRule irrelevantPageRule =
				testGetSiteSiteByExternalReferenceCodePageRulePageRuleConditionsPage_addPageRule(
					irrelevantSiteExternalReferenceCode,
					irrelevantPageRuleExternalReferenceCode,
					randomIrrelevantPageRule());
	...
	protected void assertValid(PageRuleCondition pageRuleCondition) {
		...
		for (String additionalAssertFieldName :
				getAdditionalPageRuleConditionAssertFieldNames()) {
	...
	protected void assertValid(PageRuleAction pageRuleAction) {
		boolean valid = true;

		for (String additionalAssertFieldName :
				getAdditionalPageRuleActionAssertFieldNames()) {
	...
	protected String[] getAdditionalPageRuleConditionAssertFieldNames() {
		return new String[0];
	}

	protected String[] getAdditionalPageRuleActionAssertFieldNames() {
		return new String[0];
	}
