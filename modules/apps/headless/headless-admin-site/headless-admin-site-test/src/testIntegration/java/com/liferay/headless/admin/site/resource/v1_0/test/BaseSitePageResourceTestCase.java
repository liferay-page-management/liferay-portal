...
public abstract class BaseSitePageResourceTestCase {
	...
	public void testGetSiteSiteByExternalReferenceCodeSitePageFriendlyUrlHistoryPage()
		...
		if ((irrelevantSiteExternalReferenceCode != null) &&
			...
			SitePage irrelevantSitePage =
				testGetSiteSiteByExternalReferenceCodeSitePageFriendlyUrlHistoryPage_addSitePage(
					irrelevantSiteExternalReferenceCode,
	...
	public void testGetSiteSiteByExternalReferenceCodeSitePagePageSpecificationsPage()
		...
		if ((irrelevantSiteExternalReferenceCode != null) &&
			...
			SitePage irrelevantSitePage =
				testGetSiteSiteByExternalReferenceCodeSitePagePageSpecificationsPage_addSitePage(
					irrelevantSiteExternalReferenceCode,
					irrelevantSitePageExternalReferenceCode,
					randomIrrelevantSitePage());
	...
	public void testGetSiteSiteByExternalReferenceCodeSitePageWidgetInstancesPage()
		...
		if ((irrelevantSiteExternalReferenceCode != null) &&
			...
			SitePage irrelevantSitePage =
				testGetSiteSiteByExternalReferenceCodeSitePageWidgetInstancesPage_addSitePage(
					irrelevantSiteExternalReferenceCode,
					irrelevantSitePageExternalReferenceCode,
					randomIrrelevantSitePage());
