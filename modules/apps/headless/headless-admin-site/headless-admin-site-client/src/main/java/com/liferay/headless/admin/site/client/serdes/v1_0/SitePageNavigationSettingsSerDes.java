...
public class SitePageNavigationSettingsSerDes {
	...
	public static String toJSON(
		...
		if (sitePageNavigationSettings.getNavigationSettingsType() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(sitePageNavigationSettings.getNavigationSettingsType());
	...
	public static Map<String, String> toMap(
		...
		if (sitePageNavigationSettings.getNavigationSettingsType() == null) {
			...
			map.put(
				...
				String.valueOf(
					sitePageNavigationSettings.getNavigationSettingsType()));
		}
	...
	public static class SitePageNavigationSettingsJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "queryString")) {
				return false;
						...
						jsonParserFieldName, "navigationSettingsType")) {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "queryString")) {
				...
				if (jsonParserFieldValue != null) {
					sitePageNavigationSettings.setNavigationSettingsType(
						SitePageNavigationSettings.NavigationSettingsType.
