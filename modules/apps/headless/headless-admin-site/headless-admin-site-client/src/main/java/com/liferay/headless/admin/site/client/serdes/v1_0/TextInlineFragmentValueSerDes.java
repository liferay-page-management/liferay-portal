...
public class TextInlineFragmentValueSerDes {
	...
	public static String toJSON(
		...
		if (textInlineFragmentValue.getInlineValue() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(textInlineFragmentValue.getInlineValue()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (textInlineFragmentValue.getInlineValue() == null) {
			map.put("inlineValue", null);
		}
		else {
			map.put(
				"inlineValue",
				String.valueOf(textInlineFragmentValue.getInlineValue()));
		}
	...
	public static class TextInlineFragmentValueJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "inlineValue")) {
				return false;
			}
