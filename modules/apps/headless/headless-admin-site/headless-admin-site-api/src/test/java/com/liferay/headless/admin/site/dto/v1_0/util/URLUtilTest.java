...
public class URLUtilTest {
	...
	@Test
	public void testGetByteArrayWithLocalNetworkAddressInTestMode()
		throws Exception {
		...
		try (MockedStatic<ExportImportAttachmentManagerUtil>
			...
			MockedStatic<HttpUtil> httpUtilMockedStatic = Mockito.mockStatic(
				HttpUtil.class);
			MockedStatic<PortalRunMode> portalRunModeMockedStatic =
				Mockito.mockStatic(PortalRunMode.class)) {
			...
			portalRunModeMockedStatic.when(
			...
			Assert.assertArrayEquals(
				expectedBytes, URLUtil.getByteArray(_LOCAL_URL));
		}
	}
