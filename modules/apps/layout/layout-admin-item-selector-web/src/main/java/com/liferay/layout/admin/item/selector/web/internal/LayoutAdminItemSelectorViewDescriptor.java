 ...
 */
public class LayoutAdminItemSelectorViewDescriptor
	implements ItemSelectorViewDescriptor<Theme> {

	public LayoutAdminItemSelectorViewDescriptor(
		HttpServletRequest httpServletRequest,
		LayoutAdminItemSelectorDisplayContext
			layoutAdminItemSelectorDisplayContext) {

		_httpServletRequest = httpServletRequest;
		_layoutAdminItemSelectorDisplayContext =
			layoutAdminItemSelectorDisplayContext;
	}
	...
	public ItemDescriptor getItemDescriptor(Theme theme) {
		return new LayoutAdminItemDescriptor(theme, _httpServletRequest);
	}
	...
	public SearchContainer<Theme> getSearchContainer() {
		return _layoutAdminItemSelectorDisplayContext.
			getThemesSearchContainer();
	}

	@Override
	public TableItemView getTableItemView(Theme theme) {
		return new LayoutAdminTableItemView(theme, _httpServletRequest);
	}
	...
	private final LayoutAdminItemSelectorDisplayContext
		_layoutAdminItemSelectorDisplayContext;
