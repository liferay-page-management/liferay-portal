					...
					<c:otherwise>
						...
						<div class="form-group mb-2">
							...
							<div class="align-items-center d-flex">
								<aui:input label="<%= StringPool.BLANK %>" name="openGraphImageTitle" placeholder="no-image-is-loaded" readonly="<%= true %>" title="image" type="text" value="<%= layoutsSEODisplayContext.getOpenGraphImageTitle() %>" wrapperCssClass="flex-grow-1 mb-0 mr-2" />
