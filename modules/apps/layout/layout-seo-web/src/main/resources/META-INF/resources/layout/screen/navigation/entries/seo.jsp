			...
			>
				<clay:sheet-section>
					<div aria-labelledby="<%= liferayPortletResponse.getNamespace() %>sitemapTitle" role="group">
						...
						<c:if test="<%= layoutsSEODisplayContext.showIncludeChildPagesInSitemap() %>">
							<aui:input checked="<%= layoutsSEODisplayContext.isIncludeChildPagesInSitemap() %>" label="include-child-page-urls-in-the-xml-sitemap" labelCssClass="font-weight-normal" name="TypeSettingsProperties--sitemap-include-child-pages--" type="checkbox" wrapperCssClass="mb-2" />
