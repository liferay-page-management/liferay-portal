...
import canBePasted from '../../../../src/main/resources/META-INF/resources/page_editor/app/utils/canBePasted';
...
describe('canBePasted', () => {
	it('can paste into the root item', () => {
		expect(
			canBePasted(
	...
	it('can paste into the same fragment', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(),
	...
	it('can paste the fragment in a container', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(),
	...
	it('cannot paste into the master page dropzone fragment', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(),
	...
	it('cannot paste the fragment into an unmapped collection', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(),
	...
	it('can paste fragment into a mapped collection', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(),
	...
	it('can not paste the fragment into an unmapped form', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(),
	...
	it('can paste the fragment into a mapped form', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(),
	...
	it('cannot paste the widget into a mapped form', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
	...
	it('cannot paste a form field outside of a mapped form', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
	...
	it('can paste a form field inside of a mapped form', () => {
		expect(
			canBePasted(
				[getFragment().fragment01.itemId],
				getFragmentEntryLinks(INPUT_TYPE),
