	...
	private List<FragmentEntryLink> _addFragmentEntryLinks(
		...
		if (missingInputTypes.size() == 1) {
			jsonObject.put(
				...
				_language.format(
					themeDisplay.getLocale(),
					"some-fragments-are-missing.-x-fields-may-not-have-an-" +
						"associated-fragment-or-may-not-be-available-in-master",
			...
			jsonObject.put(
				...
				_language.format(
					themeDisplay.getLocale(),
					"some-fragments-are-missing.-x-and-x-fields-may-not-have-" +
						"an-associated-fragment-or-may-not-be-available-in-" +
							"master",
					new String[] {
						StringUtil.merge(
