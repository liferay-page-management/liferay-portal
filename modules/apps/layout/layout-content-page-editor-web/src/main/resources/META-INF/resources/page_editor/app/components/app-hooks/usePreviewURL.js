...
export function usePreviewURL() {
	...
	useEffect(() => {
		...
		const {
			pageEditorLayoutPreviewBaseUrl: baseURL,
		} = previewElement.dataset;

		if (!previewElement || !baseURL) {
			return;
		}
		...
		if (
			...
			parameters = {
				...parameters,
				className: displayPagePreviewItem.data.className,
				classPK: displayPagePreviewItem.data.classPK,
			};
		}
