		...
		if (
			...
			openToast({
				message: Liferay.Util.sub(
					Liferay.Language.get(
						'the-required-field-x-was-deleted-.a-form-with-missing-required-fields-will-not-generate-a-valid-entry'
					),
					getFieldLabel(fieldId, formFields)
				),
				type: 'warning',
			});
		}
			...
			openToast({
				message: Liferay.Language.get(
					'the-deleted-fragment-contained-required-fields-.-a-form-with-missing-required-fields-will-not-generate-a-valid-entry'
				),
				type: 'warning',
			});
		}
