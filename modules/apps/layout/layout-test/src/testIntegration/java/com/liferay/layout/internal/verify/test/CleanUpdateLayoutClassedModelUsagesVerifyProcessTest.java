...
public class CleanUpdateLayoutClassedModelUsagesVerifyProcessTest
	...
	public void testCleanUpdateLayoutClassedModelUsagesVerifyProcess()
		throws Exception {
	...
	@Inject(
		filter = "component.name=com.liferay.layout.internal.verify.CleanUpdateLayoutClassedModelUsagesVerifyProcess"
	)
