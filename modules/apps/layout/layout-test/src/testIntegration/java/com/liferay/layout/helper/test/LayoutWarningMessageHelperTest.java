...
public class LayoutWarningMessageHelperTest {
	...
	@Test
	public void testGetWarningMessageWithDisplayAllItems() throws Exception {
		int totalCount = PropsValues.SEARCH_CONTAINER_PAGE_MAX_DELTA - 1;

		ServiceRegistration<InfoCollectionProvider<?>> serviceRegistration =
			_getServiceRegistration(totalCount);

		_collectionStyledLayoutStructureItem.setDisplayAllItems(true);
	...
	@Test
	public void testGetWarningMessageWithTotalCountHigherThanSearchContainerPageMaxDelta()
		throws Exception {
		...
		_collectionStyledLayoutStructureItem.setDisplayAllItems(false);
		_collectionStyledLayoutStructureItem.setNumberOfItems(totalCount);
