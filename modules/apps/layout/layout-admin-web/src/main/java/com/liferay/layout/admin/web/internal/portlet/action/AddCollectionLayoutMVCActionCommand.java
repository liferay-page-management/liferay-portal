...
public class AddCollectionLayoutMVCActionCommand
	...
	private String _getCollectionLayoutDefinitionJSON(
		String collectionType, String collectionPK) {
		...
		Map<String, String> values = HashMapBuilder.put(
			"CLASS_NAME", collectionType
		).put(
			"CLASS_PK", collectionPK
		).put(
	...
	private String _getCollectionProviderLayoutDefinition(String collectionPK) {
