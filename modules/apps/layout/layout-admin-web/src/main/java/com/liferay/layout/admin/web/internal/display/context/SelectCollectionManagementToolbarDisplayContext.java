...
import com.liferay.layout.admin.web.internal.security.permission.resource.AssetListPermission;
...
public class SelectCollectionManagementToolbarDisplayContext
	...
	public CreationMenu getCreationMenu() {
		return CreationMenuBuilder.addPrimaryDropdownItem(
			_getAssetListEntryDropdownItem(
	...
	private UnsafeConsumer<DropdownItem, Exception>
		_getAssetListEntryDropdownItem(String label, String title, int type) {
		...
		return dropdownItem -> {
			...
			dropdownItem.putData(
				"addAssetListEntryURL", addManualAssetListEntryURL.toString());
			dropdownItem.putData(
				"namespace",
