...
>
	...
	<c:if test='<%= group.isLayoutPrototype() || !(selLayoutType.isURLFriendliable() && !layoutsAdminDisplayContext.isDraft() && (!selLayout.isSystem() || selLayout.isTypeAssetDisplay()) && FeatureFlagManagerUtil.isEnabled("LPS-183727")) %>'>
