...
public class FragmentEntryLinkLocalServiceUtil {
	...
	public static void deleteFragmentEntryLinksByFragmentEntryERCScopeERC(
		long groupId, String fragmentEntryERC, String fragmentEntryScopeERC) {

		getService().deleteFragmentEntryLinksByFragmentEntryERCScopeERC(
	...
	public static List<FragmentEntryLink>
		...
		return getService().getAllFragmentEntryLinksByFragmentEntryERCScopeERC(
			groupId, fragmentEntryERC, fragmentEntryScopeERC, start, end,
			orderByComparator);
	}

	public static int getAllFragmentEntryLinksCountByFragmentEntryERCScopeERC(
		long groupId, String fragmentEntryERC, String fragmentEntryScopeERC) {
	...
	public static List<FragmentEntryLink>
		...
		return getService().getFragmentEntryLinksByFragmentEntryERCScopeERC(
			groupId, fragmentEntryERC, fragmentEntryScopeERC);
	}
	...
	public static int getFragmentEntryLinksCountByFragmentEntryERCScopeERC(
		long groupId, String fragmentEntryERC, String fragmentEntryScopeERC,
		boolean deleted) {
