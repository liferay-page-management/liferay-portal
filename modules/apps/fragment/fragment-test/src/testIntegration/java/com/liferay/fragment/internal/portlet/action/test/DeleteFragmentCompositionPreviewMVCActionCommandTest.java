...
public class DeleteFragmentCompositionPreviewMVCActionCommandTest {
    ...
    public void testDeleteFragmentCompositionPreview() throws Exception {
        ...
        fragmentComposition = _fragmentCompositionLocalService.updateFragmentComposition(
                fragmentComposition.getFragmentCompositionId(),
        ...
        fragmentComposition = _fragmentCompositionLocalService.fetchFragmentComposition(
                fragmentComposition.getFragmentCompositionId());
    ...
    @Inject(filter = "mvc.command.name=/fragment/delete_fragment_composition_preview")
