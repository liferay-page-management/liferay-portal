...
public class FragmentEntryLinkPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newFragmentEntryLink.setOriginalFragmentEntryLinkExternalReferenceCode(
			RandomTestUtil.randomString());

		newFragmentEntryLink.setFragmentEntryExternalReferenceCode(
			RandomTestUtil.randomString());

		newFragmentEntryLink.setFragmentEntryScopeExternalReferenceCode(
			RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingFragmentEntryLink.
				getOriginalFragmentEntryLinkExternalReferenceCode(),
			newFragmentEntryLink.
				getOriginalFragmentEntryLinkExternalReferenceCode());
		Assert.assertEquals(
			existingFragmentEntryLink.getFragmentEntryExternalReferenceCode(),
			newFragmentEntryLink.getFragmentEntryExternalReferenceCode());
		Assert.assertEquals(
			existingFragmentEntryLink.
				getFragmentEntryScopeExternalReferenceCode(),
			newFragmentEntryLink.getFragmentEntryScopeExternalReferenceCode());
		Assert.assertEquals(
	...
	protected OrderByComparator<FragmentEntryLink> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"originalFragmentEntryLinkExternalReferenceCode", true,
			"fragmentEntryExternalReferenceCode", true,
			"fragmentEntryScopeExternalReferenceCode", true,
