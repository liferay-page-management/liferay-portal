	...
	public void testUpgrade() throws Exception {
		...
		String editableValues = StringUtil.replace(
			...
			HashMapBuilder.put(
				...
				"CLASS_PK1", String.valueOf(dlFileEntry1.getPrimaryKey())
			).put(
				"CLASS_PK2", String.valueOf(dlFileEntry2.getPrimaryKey())
			).build());
		...
		_layoutClassedModelUsageLocalService.addLayoutClassedModelUsage(
			...
			dlFileEntry1.getFileEntryId(), StringPool.BLANK,
			RandomTestUtil.randomString(), RandomTestUtil.randomLong(),
			draftLayout.getPlid(), new ServiceContext());
		_layoutClassedModelUsageLocalService.addLayoutClassedModelUsage(
			_group.getGroupId(),
			_classNameLocalService.getClassNameId(FileEntry.class.getName()),
			dlFileEntry2.getFileEntryId(), StringPool.BLANK,
			RandomTestUtil.randomString(), RandomTestUtil.randomLong(),
			draftLayout.getPlid(), new ServiceContext());
