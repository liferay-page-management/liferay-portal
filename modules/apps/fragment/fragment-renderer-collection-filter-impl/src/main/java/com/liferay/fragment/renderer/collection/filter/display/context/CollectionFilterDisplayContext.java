...
package com.liferay.fragment.renderer.collection.filter.display.context;
 ...
 * @author Pablo.Molina
 */
public class CollectionFilterDisplayContext {

	public CollectionFilterDisplayContext(
	...
	public Map<String, Object> getCollectionFilterRegisterProps() {
		if (_collectionFilterRegisterProps != null) {
			return _collectionFilterRegisterProps;
		}

		_collectionFilterRegisterProps = HashMapBuilder.<String, Object>put(
			"collectionFilterParameterPrefix",
			_COLLECTION_FILTER_PARAMETER_PREFIX
		).build();
	...
	private Map<String, Object> _collectionFilterRegisterProps;
