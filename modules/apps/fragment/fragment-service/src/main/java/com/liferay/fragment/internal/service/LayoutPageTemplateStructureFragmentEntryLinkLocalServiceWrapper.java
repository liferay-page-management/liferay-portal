...
package com.liferay.fragment.internal.service;
...
public class LayoutPageTemplateStructureFragmentEntryLinkLocalServiceWrapper
	extends FragmentEntryLinkLocalServiceWrapper {

	public LayoutPageTemplateStructureFragmentEntryLinkLocalServiceWrapper() {
		this(null);
	}
	...
	public LayoutPageTemplateStructureFragmentEntryLinkLocalServiceWrapper(
		...
		super(fragmentEntryLinkLocalService);
	}
	...
	public void updateLatestChanges(long fragmentEntryLinkId)
		...
		_updateLayoutPageTemplateStructure(
			super.getFragmentEntryLink(fragmentEntryLinkId));

		super.updateLatestChanges(fragmentEntryLinkId);
	}
