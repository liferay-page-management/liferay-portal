...
public class FragmentEntryLinkImpl extends FragmentEntryLinkBaseImpl {
	...
	public void setFragmentEntryId(long fragmentEntryId) {
		if (fragmentEntryId == 0) {
			setFragmentEntryExternalReferenceCode(null);
			setFragmentEntryScopeExternalReferenceCode(null);
		}
		else {
			FragmentEntry fragmentEntry =
				FragmentEntryLocalServiceUtil.fetchFragmentEntry(
			...
			setFragmentEntryScopeExternalReferenceCode(fragmentEntryScopeERC);
		}
	}
