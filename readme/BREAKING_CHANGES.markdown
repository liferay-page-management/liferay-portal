...
Delete usages of <liferay-frontend:fieldset-group> with <div class="sheet"> and replace usages <aui:fieldset-group> with <div class="sheet"><div class="panel-group panel-group-flush">.
